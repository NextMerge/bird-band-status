...
export function CodeToggleItem({
  ...
  return (
    <div className="flex flex-col gap-px pt-px">
      ...
      >
        <span className="bg-muted text-primary-foreground-foreground group-aria-pressed/toggle:bg-primary group-aria-pressed/toggle:text-primary-foreground flex size-12 shrink-0 items-center justify-center rounded-md font-mono text-2xl font-semibold">
        ...
        {longDescription ? (
          <span className="text-muted-foreground group-aria-pressed/toggle:text-foreground col-start-2 text-sm opacity-80 lg:col-start-3">
            {longDescription}
          </span>
        ) : null}
      </Toggle>
